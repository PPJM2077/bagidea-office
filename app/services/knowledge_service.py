...
def chunk_by_token(
    ...
    *,
    ...
    return ChunkResult(chunks, ChunkStrategy.token,
    ...
    *,
    ...
    for i in range(0, len(sentences), stride):
        ...
        chunks.append(DocumentChunk(
            ...
            strategy_params={"max_sentences": max_sentences, "overlap_sentences": overlap_sentences},
        ))

    return ChunkResult(chunks, ChunkStrategy.sentence,
...
def chunk_by_paragraph(
    ...
    *,
    ...
    return ChunkResult(chunks, ChunkStrategy.paragraph,
...
class KnowledgeService:
    ...
    async def ingest_document(
        ...
        *,
        ...
        existing = [d for d in self._documents.values()
                    if d.content_hash == doc.content_hash]
    ...
    async def retrieve(
        ...
        *,
        ...
        citations = [cit for cit in self._citations.values()
                     if cit.document_id in doc_ids]
    ...
    async def create_memory(
        ...
        *,
        ...
        if embed and entry.content:
            ...
            await self._store.upsert("memories", [
